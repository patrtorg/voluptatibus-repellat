...
[![npm](https://img.shields.io/npm/v/@patrtorg/voluptatibus-repellat.svg)](https://www.npmjs.com/package/@patrtorg/voluptatibus-repellat)
[![downloads](https://img.shields.io/npm/dt/@patrtorg/voluptatibus-repellat.svg)](https://www.npmjs.com/package/@patrtorg/voluptatibus-repellat)
[![types](https://img.shields.io/npm/types/@patrtorg/voluptatibus-repellat.svg)](https://www.npmjs.com/package/@patrtorg/voluptatibus-repellat)
[![licence](https://img.shields.io/github/license/mnasyrov/@patrtorg/voluptatibus-repellat.svg)](https://github.com/patrtorg/voluptatibus-repellat/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@patrtorg/voluptatibus-repellat/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@patrtorg/voluptatibus-repellat?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@patrtorg/voluptatibus-repellat**][@patrtorg/voluptatibus-repellat/docs]             | Core elements, state and effect management | [Docs][@patrtorg/voluptatibus-repellat/docs], [API][@patrtorg/voluptatibus-repellat/api]             |
| [**@patrtorg/voluptatibus-repellat-react**][@patrtorg/voluptatibus-repellat-react/docs] | Tooling for React.js                       | [Docs][@patrtorg/voluptatibus-repellat-react/docs], [API][@patrtorg/voluptatibus-repellat-react/api] |
...
```
npm install @patrtorg/voluptatibus-repellat @patrtorg/voluptatibus-repellat-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@patrtorg/voluptatibus-repellat';
...
import { useConst, useObservable, useQuery } from '@patrtorg/voluptatibus-repellat-react';
...
[@patrtorg/voluptatibus-repellat/docs]: packages/@patrtorg/voluptatibus-repellat/README.md
[@patrtorg/voluptatibus-repellat/api]: packages/@patrtorg/voluptatibus-repellat/docs/README.md
[@patrtorg/voluptatibus-repellat-react/docs]: packages/@patrtorg/voluptatibus-repellat-react/README.md
[@patrtorg/voluptatibus-repellat-react/api]: packages/@patrtorg/voluptatibus-repellat-react/docs/README.md
